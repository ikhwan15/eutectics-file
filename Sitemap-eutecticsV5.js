...
function displayToc(a) {
    ...
    if (l == postTitle.length) {
        var f = '<span class="toc-note">Displaying all ' + postTitle.length + " article<br/></span>"
    } else {
        var f = '<span class="toc-note">Displaying ' + l + " article by category '";
...
function showToc() {
    if (tocLoaded) {
        ...
        alert("Please wait... TOC is loading")
    }
}
...
function hideToc() {
    ...
    b.innerHTML = '<a href="#" onclick="scroll(0,0); showToc(); Effect.toggle(\'toc-result\',\'blind\');">?? Menampilkan Daftar Isi</a> <img src="http://3.bp.blogspot.com/-igF2iDKKqNw/TyVmWE5G8_I/AAAAAAAACjM/mbQX5Bc6pn4/s1600/new_1.gif.png"/>'
}
